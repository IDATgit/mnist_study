...
def load_rsvd_eigenvalues(model_name, split='train'):
    ...
    base_dir = script_dir / f'outputs/fisher_analysis_hessian/{model_name}'
...
def compare_rsvd_eigenvalues(models, split='train', save_path=None):
    ...
    if save_path is None:
        ...
        script_dir = Path(__file__).parent
        comparison_dir = script_dir / 'outputs/fisher_analysis_hessian/rsvd_comparison'
        if not comparison_dir.exists():
            # Try from project root
            comparison_dir = Path('model_interpretation/outputs/fisher_analysis_hessian/rsvd_comparison')
